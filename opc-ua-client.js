    ...
    .then(function (data) {
        ...
        async.series([
            ...
            function (callback) {
                ...
                console.log("address suffix is ",process.env.OPC_SERVER_ADDRESS_PREFIX)
                console.log("tag prefix is ",process.env.TAG_PREFIX)

                // console.log("CLSID is ",process.env.OPC_SERVER_CLSID)
                    ...
                    TimestampsToReturn.Both, function (err, mItems) {
                        ...
                        mItems.on("changed", function (monitoredItem, dataValue, index) {
                            ...
                            try {
                                ...
                                // console.log("Krishna wala store",store);
                                let now = new Date();
